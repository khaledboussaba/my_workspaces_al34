...
window.onload=function() {
	...
	btnGetDevises.addEventListener("click", ()=> {
		...
		makeAjaxGetRequest("http://localhost:8080/springBootWsApp/devise-api/public/devise?changeMini="+changeMini, callbackGererResultat);
	});
	...
	btnPostDevise.addEventListener("click", ()=> {
		...
		makeAjaxPostRequest("http://localhost:8080/springBootWsApp/devise-api/public/devise", JSON.stringify(nouvelleDevise), callbackGererResultatPost);
	});
